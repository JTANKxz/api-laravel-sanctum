...
class HomeSectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.sections.index')->with('success', 'Seção criada com sucesso!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.sections.index')->with('success', 'Seção atualizada com sucesso!');
    }
    ...
    public function destroy(CustomHomeSection $section)
    {
        try {
            $section->delete();
            return redirect()->route('admin.sections.index')->with('success', 'Seção deletada com sucesso!');
        } catch (\Exception $e) {
