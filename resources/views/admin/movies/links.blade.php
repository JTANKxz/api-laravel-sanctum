...
@section('content')
<div class="mb-8">
    <h1 class="text-2xl font-bold mb-6">List links</h1>
    ...
    <div class="bg-medium-gray rounded-xl shadow-lg p-6 animate-fadeIn w-full">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.links.create', $movie->id) }}"
                ...
                <tbody>
                    ...
                    <tr class="border-b border-dark-gray hover:bg-dark-gray">
                        ...
                        <td class="py-3 px-4 flex items-center space-x-2">
                            <a href="{{ route('admin.links.edit', $link->id) }} " class="text-blue-400 hover:text-blue-300">
