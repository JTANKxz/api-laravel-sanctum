...
<div class="bg-medium-gray rounded-xl shadow-lg p-6 animate-fadeIn">
    <h2 class="text-xl font-bold mb-6">Editar Canal: {{ $channel->name }}</h2>
    <x-alert />

    <form action="{{ route('admin.tv.update', $channel->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description"
                    ...
                    class="w-full bg-dark-gray border border-gray-700 rounded-lg py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-netflix-red"
                    rows="3">{{ old('description', $channel->description) }}</textarea>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text"
                    name="image_url"
                    value="{{ old('image_url', $channel->image_url) }}"
